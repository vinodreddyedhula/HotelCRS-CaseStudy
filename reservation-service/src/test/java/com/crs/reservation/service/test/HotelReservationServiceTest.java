package com.crs.reservation.service.test;
...
public class HotelReservationServiceTest {
	...
	@Test
	public void doHotelResrvationTest() {
		HotelReservationResponse response = reservationAppService.doReservation(prepareReservationDTO());
	...
	@Test
	public void getHotelReservationDetailsTest() {
		HotelReservationResponse response = reservationAppService
				.getReservationDetails("4028aba77a3470d9017a3472343e0000");
		assertNotNull(response);
	}
